...
CREATE TABLE IF NOT EXISTS `obecnosc` (
  `obec_id` int(11) NOT NULL AUTO_INCREMENT,
  `zaj_id` int(11) DEFAULT NULL,
  `stud_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`obec_id`),
  KEY `FK_obecnosc_zajecia` (`zaj_id`),
...
CREATE TABLE IF NOT EXISTS `obowiazek_obecnosci` (
  `id_obec` int(11) NOT NULL AUTO_INCREMENT,
  `stud_id` int(11) DEFAULT NULL,
  `przed_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_obec`),
  KEY `FK_obowiazek_obecnosci_student` (`stud_id`),
